...
from models import user_model, role_model, oidc_model, language_model, interpreter_model, court_location_model, booking_model, geo_status_model, rate_model
...
target_metadata = court_location_model.Base.metadata
target_metadata = booking_model.Base.metadata
target_metadata = geo_status_model.Base.metadata
target_metadata = rate_model.Base.metadata
