...
export class ToastService {
   ...
   */
  public show(message: string, iconType?: ToastIconType): void  {
   ...
   */
  public clear(message: ToastModel): void {
    if (!message) { return; }
    this.que.splice(0, 1);
    this.emit();
  }
  ...
  private isTheSameAlert(item1: ToastModel, item2: ToastModel): boolean {
