...
<!-- <Expenses> -->            
            <tr>
                <th/>
                <td colspan="38" class=""><b style="font-size:11pt;">Expenses</b> (receipts attached)</td>
...
<!-- <Total paid by> -->
                    ...
                    <tr style="line-height:1.6rem;">
                        <th/>
                        <td colspan="17" class=""></td>
                        <td colspan="10" class=" text-right">Sent to Federal Crown</td>
                        <td colspan="2" class=""></td>
