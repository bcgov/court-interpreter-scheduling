<template>
    <b-card :name="section_name" class="my-5">
        <h3 class="text-dark p-0 mt-n2 mb-4">This <b class="text-primary" >form</b> has been Emailed to the interpreter for confirmation.</h3>
        ...
        <b-row class="my-n2">
            ...
            <div style="width:9%">
                <b>Sent File: </b>
                    ...
                    title="View/Download the Sent Form">
...
@Component
export default class AdmSentFormInfo extends Vue {
    ...
    mounted(){
        this.sentBy = this.booking.formSender
        this.sentDate = this.booking.formSentDate
        this.senderEmail = this.booking.formSenderEmail
        this.recipientEmail = this.booking.formRecipientEmail
        const today = moment() 
        const lastDay = moment(this.booking.formSentDate)
    ...
    public viewFormPdf(){    
        ...
        const url = '/adm/pdf/'+this.booking.id+'?type=emailed-form'
